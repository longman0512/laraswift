    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          @role('users')
          <li class="nav-item">
            <a href="/profile" class="nav-link {{request()->is('profile*')? 'sidebar-active':''}}">
          ...
          <li class="nav-item has-treeview">
            <a href="/category-tree" class="nav-link {{request()->is('category-tree*')? 'sidebar-active':''}}">
              <i class="nav-icon fa fa-tree"></i>
              <p>
                {{ __('app.tree_varietys') }}
              </p>
            </a>
          </li>
          @endrole
